...
Function ClockPgcToTxt ($strPgcIn) {
    ...
    foreach ($page in $reqpages) {
        ...
        & python.exe C:\Users\KinectProcessing\Dropbox\pen_printed_paper\clock_single_transform.py $filename         <# PYTHON SCRIPT TO CONVERT TEXT OUTPUT TO CORRECTED CSK #>
    }
}
...
### SET FOLDER TO WATCH + FILES TO WATCH + SUBFOLDERS YES/NO
    ...
    $clock_watcher.Path = "C:\Users\KinectProcessing\Documents\Anoto\Clocks"  <# CHANGE THIS DIRECTORY TO WHERE CLOCK PAPER IS STORED FROM PEN DIRECTIOR TRANSFER #>
...
### SET FOLDER TO WATCH + FILES TO WATCH + SUBFOLDERS YES/NO
    ...
    $mmse_watcher.Path = "C:\Users\KinectProcessing\Documents\Anoto\MMSE"  <# CHANGE THIS DIRECTORY TO WHERE CLOCK PAPER IS STORED FROM PEN DIRECTIOR TRANSFER #>
    $mmse_watcher.Filter = "*.pgc*"                                        <# YOU CAN COMMENT OUT IF YOU ARE NOT USING THE MMSE PAPER #>
...
### DEFINE ACTIONS AFTER AN EVENT IS DETECTED
    $clockaction = { $path = $Event.SourceEventArgs.FullPath                
                ...
                ClockPgcToTxt ($path)
                move-item ($path) -destination "C:\Users\KinectProcessing\Documents\Anoto\Rawpgc"    <# MOVES THE RAW PGC TO A BACKUP LOCATION #>
